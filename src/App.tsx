...
export default function App() {
  ...
  // Main UI States
  const [activeTab, setActiveTab] = useState<'beranda' | 'input' | 'lacak' | 'interval' | 'integrasi_gas' | 'accounts'>('beranda');
            ...
            <div className="w-full max-w-lg mx-auto text-center space-y-8 relative z-10">
              ...
              <div className="space-y-3">
                ...
                <p className="text-sm font-medium text-teal-200/80 max-w-sm mx-auto leading-relaxed">
                  Sistem Pemantauan Imunisasi Tetanus Toxoid Ibu Hamil<br />
